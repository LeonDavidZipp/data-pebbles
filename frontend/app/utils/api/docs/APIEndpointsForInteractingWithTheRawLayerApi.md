...
|------------- | ------------- | -------------|
| [**activateVersionRawResourceIdVersionsVersionPatch**](APIEndpointsForInteractingWithTheRawLayerApi.md#activateversionrawresourceidversionsversionpatch) | **PATCH** /raw/{resource_id}/versions/{version} | Activate Version |
| [**createResourceRawPost**](APIEndpointsForInteractingWithTheRawLayerApi.md#createresourcerawpost) | **POST** /raw/ | Create Resource |
| [**deleteResourceRawResourceIdDelete**](APIEndpointsForInteractingWithTheRawLayerApi.md#deleteresourcerawresourceiddelete) | **DELETE** /raw/{resource_id} | Delete Resource |
| [**deleteVersionRawResourceIdVersionsVersionDelete**](APIEndpointsForInteractingWithTheRawLayerApi.md#deleteversionrawresourceidversionsversiondelete) | **DELETE** /raw/{resource_id}/versions/{version} | Delete Version |
| [**downloadVersionRawResourceIdVersionsVersionGet**](APIEndpointsForInteractingWithTheRawLayerApi.md#downloadversionrawresourceidversionsversionget) | **GET** /raw/{resource_id}/versions/{version} | Download Version |
| [**getResourceRawResourceIdGet**](APIEndpointsForInteractingWithTheRawLayerApi.md#getresourcerawresourceidget) | **GET** /raw/{resource_id} | Get Resource |
| [**listResourcesRawGet**](APIEndpointsForInteractingWithTheRawLayerApi.md#listresourcesrawget) | **GET** /raw/ | List Resources |
| [**listVersionsRawResourceIdVersionsGet**](APIEndpointsForInteractingWithTheRawLayerApi.md#listversionsrawresourceidversionsget) | **GET** /raw/{resource_id}/versions | List Versions |
| [**updateResourceRawResourceIdPatch**](APIEndpointsForInteractingWithTheRawLayerApi.md#updateresourcerawresourceidpatch) | **PATCH** /raw/{resource_id} | Update Resource |
| [**uploadVersionRawResourceIdVersionsPost**](APIEndpointsForInteractingWithTheRawLayerApi.md#uploadversionrawresourceidversionspost) | **POST** /raw/{resource_id}/versions | Upload Version |
...
async function example() {
  ...
  const api = new APIEndpointsForInteractingWithTheRawLayerApi();
